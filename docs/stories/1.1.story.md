...
- **Testing Requirements**: Adhere to the testing pyramid using Jest for unit, integration, and E2E tests. Organize tests in tests/unit/, tests/integration/, and tests/e2e/. [Source: architecture/testing-strategy.md#testing-pyramid and #test-organization]  
